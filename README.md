...
Para su correcto funcionamiento necesitas seguir estos pasos:

1) Instala DaVinci Resolve 18+ y activa la programación mediante scripts: en Preferencias, abrimos el programa y nos vamos a Preferencias y, en la pestaña Sistema, nos vamos al apartado General. Aquí, en "Programación externa mediante" seleccionamos Local. Luego, cierra el programa
